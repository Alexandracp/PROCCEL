...
<body>
    <div class="d-flex" id="content-wrapper">
        ...
        <div class="menu">
          <a href="{{ route('admin.index') }}" class="d-block text-light p-3 border-0"><i class="fas fa-home"></i>
              Inicio</a>
        ...
        <div id="content" class="container bg-grey w-100">
            ...
            <section class="bg-mix py-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9 col-md-8">
                                    <h1 class="font-weight-bold mb-0">Edita el curso</h1>
                                </div>
                ...
                <section id="contenido" class="container pEqual" >
                    <div class="container" >
                        <div class="contenido" >
                            <form class="container " method="POST" action="{{ url('/curso/'.$curso->id_curso)}}"  role="form" enctype="multipart/form-data">
                                @csrf
                                {{method_field('PATCH')}}
