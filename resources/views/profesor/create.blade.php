        ...
        <div id="content" class="container bg-grey w-100">
            ...
            <section class="bg-mix py-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-9 col-md-8">
                                    <h1 class="font-weight-bold mb-0">Registro docente</h1>
                                </div>
                ...
                <section id="contenido" class="container pEqual" >
                    <div class="container" >
                        <div class="contenido" >
                            <form class="container " method="POST" action="{{ url('/profesor') }}"  role="form" enctype="multipart/form-data">
                                @csrf
                                <header class="contentHead">
                                    <h1 class="font-weight-bold">Datos del docente</h1>
                                </header>
